...
public class ExtentManager {
    ...
    private static String xPlatformPath = System.getProperty("user.dir") + "/TestReport";
    private static String xPlatformFileLoc = xPlatformPath + "/" + reportFileName;
    ...
    private static String getReportFileLocation(Platform platform) {
        ...
        switch (platform) {
            ...
            case WINDOWS:
                ...
                reportFileLocation = xPlatformFileLoc;
                //createReportPath(windowsPath);
                createReportPath(xPlatformPath);
